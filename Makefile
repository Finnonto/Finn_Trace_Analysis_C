...
sim:
	./bin/Finn_trace_analysis simulation -l 500000 -r 30000  -k 20 -z 1.4 -t 3  -a 2  Clifford  Clifford_cdf   -it 20 -tbint 0 -tbidx 0 -Tbs 65536 -resolution 14 -interth 16 16 -interspan 4 -Chash 0 -CCliffordSeed 1 -hseed 3
