...
sim:
	./bin/Finn_trace_analysis simulation -l 500000 -r 30000  -k 200 -z 1.4 -t  3 -PA 0.999999 -a 5  Clifford  Clifford_cdf  Clifford_cdf_parallel Clifford_cdf_parallel_interpolation Clifford_cdf_parallel_interpolation_2th -it 200 -tbint 0 -tbidx 4 -Tbs 65536 -resolution 14 -interth 10 15 -interspan 4
