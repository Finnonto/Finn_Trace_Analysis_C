...
sim:
	./bin/Finn_trace_analysis simulation -l 500000 -r 30000  -k 20 -z 1.4 -t  3 -PA 0.999999 -a 3  Clifford  Clifford_cdf  PingLi  -it 1 -tbint 0 -tbidx 4 -Tbs 1024 -resolution 16
