...
void Output_Simulation()
{
	...
	sprintf(filename,"%d_%.1f_%d_%d_K%d.csv",zipf_slen,zipf_par,zipf_range,resolution,K_Value);
...
void Output_Trace()
{
	...
	sprintf(filename,"%d_sec_%d_%d_K%d.csv",intervalTime,resolution,Table_Size,K_Value);
